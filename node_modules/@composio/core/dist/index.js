...
// src/types/mcp.experimental.types.ts
import z8 from "zod/v3";
var MCPServerInstanceSchema = z8.object({
  id: z8.string(),
  name: z8.string(),
  type: z8.literal("streamable_http"),
  url: z8.string(),
  userId: z8.string(),
  allowedTools: z8.array(z8.string()),
  authConfigs: z8.array(z8.string())
});
var MCPConfigToolkitsSchema = z8.object({
  toolkit: z8.string().describe("Id of the toolkit").optional(),
  authConfigId: z8.string().describe("Id of the auth config").optional()
});
var MCPConfigCreationParamsSchema = z8.object({
  toolkits: z8.array(z8.union([MCPConfigToolkitsSchema, z8.string()])),
  allowedTools: z8.array(z8.string()).optional(),
  manuallyManageConnections: z8.boolean().default(false).optional().describe(
...
var MCPConfigResponseSchema = z8.object({
  /**
   ...
   */
  authConfigIds: z8.array(z8.string()),
  /**
...
var MCPGetInstanceParamsSchema = z8.object({
  manuallyManageConnections: z8.boolean().default(false).optional().describe(
    `Whether to manually manage accounts. If true, you need to manage accounts manually connect user accounts. 
If set to false, composio will inject account maangement tools into your mcp server for agents to request and authenticate accounts.
defaults to false`
...
var MCPListParamsSchema = z8.object({
  page: z8.number().optional().default(1),
  limit: z8.number().optional().default(10),
  toolkits: z8.array(z8.string()).optional().default([]),
  authConfigs: z8.array(z8.string()).optional().default([]),
  name: z8.string().optional()
});
var MCPItemSchema = MCPConfigResponseSchema.extend({
  ...z8.object({
    toolkitIcons: z8.record(z8.string(), z8.string()),
    serverInstanceCount: z8.number(),
    toolkits: z8.array(z8.string())
  }).shape
});
var MCPListResponseSchema = z8.object({
  items: z8.array(MCPItemSchema),
  currentPage: z8.number(),
  totalPages: z8.number()
});
var MCPUpdateParamsSchema = z8.object({
  name: z8.string().optional(),
  toolkits: z8.array(z8.union([MCPConfigToolkitsSchema, z8.string()])).optional(),
  allowedTools: z8.array(z8.string()).optional(),
  manuallyManageConnections: z8.boolean().optional().describe(
    `Whether to manually manage accounts. If true, you need to manage accounts manually connect user accounts. 
If set to false, composio will inject account maangement tools into your mcp server for agents to request and authenticate accounts.
defaults to false`
  )
});
var MCPServerConnectionStatus = z8.object({
  connected: z8.boolean(),
  toolkit: z8.string(),
  connectedAccountId: z8.string()
});
var MCPServerConnectedAccountsSchema = z8.record(
  z8.string(),
  z8.array(
    z8.object({
      toolkit: z8.string(),
      authConfigId: z8.string(),
      connectedAccountId: z8.string()
    })
  )
);

// src/models/MCP.experimental.ts
...
var MCP = class {
  ...
  async create(name, mcpConfig) {
    ...
    const camelCaseServer = transform(server).with(MCPConfigResponseSchema).using((raw) => ({
      name: raw.name,
      allowedTools: raw.allowed_tools,
      id: raw.id,
      authConfigIds: raw.auth_config_ids,
  ...
  async list(options) {
    ...
    const transformedListResponse = transform(listResponse).with(MCPListResponseSchema).using((raw) => ({
...
var MCPToolkitConfigSchema = z9.object({
  toolkit: z9.string().min(1, "Toolkit name cannot be empty"),
  authConfigId: z9.string().min(1, "Auth config ID cannot be empty"),
  allowedTools: z9.array(z9.string().min(1, "Tool name cannot be empty")).min(1, "At least one tool must be specified")
});
var MCPToolkitConfigsArraySchema = z9.array(MCPToolkitConfigSchema).min(1, "At least one toolkit configuration is required").refine((configs) => {
...
var MCPAuthOptionsSchema = z9.object({
  isChatAuth: z9.boolean().optional()
});
var MCPGetServerParamsSchema = z9.object({
  userId: z9.string().min(1, "User ID cannot be empty").optional(),
  connectedAccountIds: z9.record(z9.string(), z9.string().min(1, "Account ID cannot be empty")).optional()
}).refine(
  (data) => {
...
var MCPGenerateURLParamsSchema = z9.object({
  userIds: z9.array(z9.string()).optional(),
  connectedAccountIds: z9.array(z9.string()).optional(),
  isChatAuth: z9.boolean().optional()
});
var ComposioGenerateURLParamsSchema = z9.object({
  user_ids: z9.array(z9.string()).optional(),
  connected_account_ids: z9.array(z9.string()).optional(),
  mcp_server_id: z9.string(),
  managed_auth_by_composio: z9.boolean().optional()
});
var GenerateURLParamsSchema = z9.object({
  userIds: z9.array(z9.string()).optional(),
  connectedAccountIds: z9.array(z9.string()).optional(),
  mcpServerId: z9.string(),
  composioManagedAuth: z9.boolean().optional()
});
var GenerateURLResponseSchema = z9.object({
  connectedAccountUrls: z9.array(z9.string()).optional(),
  userIdsUrl: z9.array(z9.string()).optional(),
  mcpUrl: z9.string().min(1, "MCP URL cannot be empty")
});
var ComposioGenerateURLResponseSchema = z9.object({
  connected_account_urls: z9.array(z9.string()).optional(),
  user_ids_url: z9.array(z9.string()).optional(),
  mcp_url: z9.string().min(1, "MCP URL cannot be empty")
});
var MCPSingleAppServerSchema = z9.object({
  name: z9.string().describe("Name of the MCP server"),
  tools: z9.array(z9.string()).describe("List of allowed tools"),
  authConfigId: z9.string().optional().describe("Auth config ID for the server")
});
var MCPMultiAppServerSchema = z9.object({
  name: z9.string().describe("Name of the MCP server"),
  tools: z9.array(z9.string()).describe("List of allowed tools across toolkits"),
  toolkits: z9.array(z9.string()).describe("List of allowed toolkits")
});
var MCPServerSchema = z9.object({
  id: z9.string().describe("Unique identifier for the MCP server"),
  type: z9.enum(["single", "multi"]).describe("Type of MCP server"),
  createdAt: z9.string().describe("Creation timestamp"),
  updatedAt: z9.string().describe("Last update timestamp"),
  status: z9.enum(["active", "inactive", "error"]).default("active"),
  config: z9.union([MCPSingleAppServerSchema, MCPMultiAppServerSchema])
});
var MCPServerListResponseSchema = z9.object({
  items: z9.array(MCPServerSchema),
  total: z9.number(),
  page: z9.number(),
  pageSize: z9.number()
});
var MCPServerUpdateParamsSchema = z9.object({
  name: z9.string().optional().describe("New name for the server"),
  toolkits: z9.array(z9.string()).optional().describe("Updated list of toolkits"),
  allowedTools: z9.array(z9.string()).optional().describe("Updated list of allowed tools")
});
...
var CustomCreateResponseSchema = z9.object({
  id: z9.string().min(1, "Server ID cannot be empty"),
  name: z9.string().min(1, "Server name cannot be empty"),
  createdAt: z9.string().nullish(),
  updatedAt: z9.string().nullish(),
  status: z9.string().nullish()
});
var ComposioCustomCreateResponseSchema = z9.object({
  id: z9.string().min(1, "Server ID cannot be empty"),
  name: z9.string().min(1, "Server name cannot be empty"),
...
var McpListResponseSchema = z9.object({
  items: z9.array(
    z9.object({
      id: z9.string().min(1, "Server ID cannot be empty"),
      name: z9.string().min(1, "Server name cannot be empty"),
...
var ComposioMcpListResponseSchema = z9.object({
  items: z9.array(
    z9.object({
      id: z9.string().min(1, "Server ID cannot be empty"),
      name: z9.string().min(1, "Server name cannot be empty"),
...
var McpRetrieveResponseSchema = z9.object({
  id: z9.string().min(1, "Server ID cannot be empty"),
  name: z9.string().min(1, "Server name cannot be empty"),
  createdAt: z9.string().optional(),
  updatedAt: z9.string().optional(),
  status: z9.string().optional(),
  toolkits: z9.array(z9.string()).optional(),
  tools: z9.array(z9.string()).optional(),
  managedAuthViaComposio: z9.boolean().optional(),
  authConfigIds: z9.array(z9.string()).optional(),
  mcpUrl: z9.string(),
  commands: z9.object({
    claude: z9.string(),
    cursor: z9.string(),
...
var ComposioMcpRetrieveResponseSchema = z9.object({
  id: z9.string().min(1, "Server ID cannot be empty"),
  name: z9.string().min(1, "Server name cannot be empty"),
  created_at: z9.string().optional(),
  updated_at: z9.string().optional(),
  ...
  toolkits: z9.array(z9.string()).optional(),
  tools: z9.array(z9.string()).optional(),
  managed_auth_via_composio: z9.boolean().optional()
});
var McpDeleteResponseSchema = z9.object({
  id: z9.string().min(1, "Server ID cannot be empty"),
  deleted: z9.boolean().optional(),
  message: z9.string().optional()
});
var ComposioMcpDeleteResponseSchema = z9.object({
  id: z9.string().min(1, "Server ID cannot be empty"),
  deleted: z9.boolean().optional(),
  message: z9.string().optional()
});
var McpUpdateResponseSchema = z9.object({
  id: z9.string().min(1, "Server ID cannot be empty"),
  name: z9.string().min(1, "Server name cannot be empty"),
  createdAt: z9.string().optional(),
  updatedAt: z9.string().optional(),
...
var ComposioMcpUpdateResponseSchema = z9.object({
  id: z9.string().min(1, "Server ID cannot be empty"),
  name: z9.string().min(1, "Server name cannot be empty"),
  created_at: z9.string().optional(),
  updated_at: z9.string().optional(),
...
// src/types/toolRouter.types.ts
import z10 from "zod/v3";
var ToolRouterToolkitConfigSchema = z10.object({
  toolkit: z10.string(),
  authConfigId: z10.string().optional()
});
var ToolRouterConfigSchema = z10.object({
  toolkits: z10.array(z10.union([z10.string(), ToolRouterToolkitConfigSchema])).optional(),
  manuallyManageConnections: z10.boolean().optional()
});
var ToolRouterSessionSchema = z10.object({
  sessionId: z10.string(),
  url: z10.string()
});

// src/models/ToolRouter.experimental.ts
var ToolRouter = class {
   ...
   * ```
   */
  async createSession(userId, routerConfig) {
    ...
    const toolkitConfig = config.data.toolkits?.map((config2) => {
      if (typeof config2 === "string") {
        return { toolkit: config2 };
      } else {
        return {
          toolkit: config2.toolkit,
          auth_config_id: config2.authConfigId
        };
      }
    });
    ...
    return transform(session).with(ToolRouterSessionSchema).using((raw) => ({
...
var Composio = class _Composio {
  ...
  constructor(config) {
    ...
    this.deprecated = {
       ...
       */
      mcp: new MCP2(this.client, this.provider)
    };
